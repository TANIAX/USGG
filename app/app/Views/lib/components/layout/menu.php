                    ...
                    <ul>
                        <li class="py-4 pl-2 md:pl-64 hover:bg-gray-50 rounded-lg">
                            <a href="#" class="-m-3 flex items-start rounded-lg p-3">
                                ...
                                <div class="ml-4">
                                    <p class="text-base font-medium text-gray-900">Inscription</p>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="py-4 pl-2 md:pl-64 hover:bg-gray-50 rounded-lg">
                            <a href="#" class="-m-3 flex items-start rounded-lg p-3">
                                ...
                                <div class="ml-4">
                                    <p class="text-base font-medium text-gray-900">Cotisation</p>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="py-4 pl-2 md:pl-64 hover:bg-gray-50 rounded-lg">
                            <a href="#" class="-m-3 flex items-start rounded-lg p-3">
                                ...
                                <div class="ml-4">
                                    <p class="text-base font-medium text-gray-900">Bon à savoir</p>
                                </div>
                            </a>
                        </li>
                    </ul>
