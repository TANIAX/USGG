<footer class="bg-white w-full" aria-labelledby="footer-heading">
  ...
  <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
      ...
      <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
        ...
        <div class="md:grid md:grid-cols-2 md:gap-8">
          ...
          <div class="mt-10 md:mt-0">
            ...
            <ul role="list" class="mt-6 space-y-4">
              <li>
                <a href="#" class="text-sm leading-6 text-gray-600 hover:text-gray-900">Inscription</a>
              </li>
              <li>
                <a href="#" class="text-sm leading-6 text-gray-600 hover:text-gray-900">Cotisation</a>
              </li>
              <li>
                <a href="#" class="text-sm leading-6 text-gray-600 hover:text-gray-900">Agenda</a>
              </li>
              <li>
                <a href="#" class="text-sm leading-6 text-gray-600 hover:text-gray-900">Bon à savoir</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
      <p class="text-xs leading-5 text-gray-500">&copy; <?= date("Y"); ?> U.S.G.G., Inc. Tous droits réservés.</p>
    </div>
  </div>
</footer>
