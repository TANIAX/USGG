<nav class="flex justify-around	md:justify-start" x-data="{ open_guide: false, open_scout: false, open_asbl: false}">
    ...
    <div class="relative flex">
        <button @click="open_guide = ! open_guide; open_scout = false ; open_asbl = false" type="button" class="text-gray-500 group p-4 inline-flex items-center rounded-md bg-white text-base font-medium hover:text-gray-900" aria-expanded="false">
        ...
        <div x-show="open_guide" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-90" class="fixed left-0  z-50 mt-32 w-screen">
            ...
            <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                <div class="relative grid gap-6 bg-slate-100 px-5 py-6 sm:gap-8 sm:p-8">
                    ...
                    <ul class="">
                        <li class="py-4 pl-64 hover:bg-gray-50">
                            <a href="#" class="-m-3 flex items-start rounded-lg p-3">
                                ...
                                <div class="ml-4">
                                    <p class="text-base font-bold text-gray-900">Présentation</p>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="py-4 pl-64 hover:bg-gray-50">
                            <a href="#" class="-m-3 flex items-start rounded-lg p-3">
                                ...
                                <div class="ml-4">
                                    <p class="text-base font-bold text-gray-900">Staff d'unité</p>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="py-4 pl-64 hover:bg-gray-50">
                            <a href="#" class="-m-3 flex items-start rounded-lg p-3">
                                ...
                                <div class="ml-4">
                                    <p class="text-base font-bold text-gray-900">Documents</p>
                                </div>
                            </a>
                        </li>
    ...
    <!-- SCOUTS -->
    <div class="relative flex">
        <button @click="open_scout = ! open_scout; open_guide = false; open_asbl = false" type="button" class="text-gray-500 group p-4 inline-flex items-center rounded-md bg-white text-base font-medium hover:text-gray-900" aria-expanded="false">
    ...
    <!-- ASBL -->
    <div class="relative flex">
        <button @click="open_asbl = ! open_asbl; open_guide = false; open_scout = false" type="button" class="text-gray-500 group p-4 inline-flex items-center rounded-md bg-white text-base font-medium hover:text-gray-900" aria-expanded="false">
